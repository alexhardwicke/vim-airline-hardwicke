let g:airline#themes#hardwicke#palette = {}

function! airline#themes#hardwicke#refresh()
  """"""""""""""""""""""""""""""""""""""""""""""""
  " Options
  """"""""""""""""""""""""""""""""""""""""""""""""
  ...
  let g:airline#themes#hardwicke#palette.accents = {
        \ 'red': s:NFa,
        \ }

  let g:airline#themes#hardwicke#palette.inactive = airline#themes#generate_color_map(
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]],
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]],
        \ [s:IA[0].g, s:IA[1].g, s:IA[0].t, s:IA[1].t, s:IA[2]])
  let g:airline#themes#hardwicke#palette.inactive_modified = {
  ...
  let g:airline#themes#hardwicke#palette.normal.airline_warning = [
        \ s:NW[0].g, s:NW[1].g, s:NW[0].t, s:NW[1].t, s:NW[2]]

  let g:airline#themes#hardwicke#palette.normal_modified = {
        \ 'airline_c': [s:NM[0].g, s:NM[1].g,
        \ s:NM[0].t, s:NM[1].t, s:NM[2]]}

  let g:airline#themes#hardwicke#palette.normal_modified.airline_warning =
        \ g:airline#themes#hardwicke#palette.normal.airline_warning

  let g:airline#themes#hardwicke#palette.insert = airline#themes#generate_color_map(
        \ [s:I1[0].g, s:I1[1].g, s:I1[0].t, s:I1[1].t, s:I1[2]],
        \ [s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]],
        \ [s:I3[0].g, s:I3[1].g, s:I3[0].t, s:I3[1].t, s:I3[2]])

  let g:airline#themes#hardwicke#palette.insert.airline_warning =
        \ g:airline#themes#hardwicke#palette.normal.airline_warning

  let g:airline#themes#hardwicke#palette.insert_modified = {
        \ 'airline_c': [s:IM[0].g, s:IM[1].g,
        \ s:IM[0].t, s:IM[1].t, s:IM[2]]}

  let g:airline#themes#hardwicke#palette.insert_modified.airline_warning =
        \ g:airline#themes#hardwicke#palette.normal.airline_warning

  let g:airline#themes#hardwicke#palette.visual = airline#themes#generate_color_map(
  ...
  let g:airline#themes#hardwicke#palette.visual.airline_warning =
        \ g:airline#themes#hardwicke#palette.normal.airline_warning

  let g:airline#themes#hardwicke#palette.visual_modified = {
        \ 'airline_c': [s:VM[0].g, s:VM[1].g,
        \ s:VM[0].t, s:VM[1].t, s:VM[2]]}

  let g:airline#themes#hardwicke#palette.visual_modified.airline_warning =
        \ g:airline#themes#hardwicke#palette.normal.airline_warning

  let g:airline#themes#hardwicke#palette.replace = airline#themes#generate_color_map(
  ...
  let g:airline#themes#hardwicke#palette.replace.airline_warning =
        \ g:airline#themes#hardwicke#palette.normal.airline_warning

  let g:airline#themes#hardwicke#palette.replace_modified = {
        \ 'airline_c': [s:RM[0].g, s:RM[1].g,
        \ s:RM[0].t, s:RM[1].t, s:RM[2]]}

  let g:airline#themes#hardwicke#palette.replace_modified.airline_warning =
        \ g:airline#themes#hardwicke#palette.normal.airline_warning

  let g:airline#themes#hardwicke#palette.tabline = {}

  let g:airline#themes#hardwicke#palette.tabline.airline_tab = [
        \ s:I2[0].g, s:I2[1].g, s:I2[0].t, s:I2[1].t, s:I2[2]]

  let g:airline#themes#hardwicke#palette.tabline.airline_tabtype = [
        \ s:N2[0].g, s:N2[1].g, s:N2[0].t, s:N2[1].t, s:N2[2]]
endfunction

call airline#themes#hardwicke#refresh()
